  ...
  function executeScript({
    ...
    function execute() {
      ...
      if (massageToMessage) {
        ((element) => {
          if (element) {
            element.innerHTML = element.innerHTML.replace("Massage", "Message");
          }
        })(
...
`;
          ...
          copyButtons.forEach((button) => {
            button.addEventListener("click", () => {
              ...
              const checkMark = button.querySelector("svg > path:first-child");
          ...
          if (testCasesResult) {
            ...
            for (const row of rows) {
              ...
              const output = outputTextarea
                ...
                : cells[3].textContent;
              const expectedOutputTextarea = cells[4].querySelector("textarea");
...
`;
          ...
          if (result.compilerMessage && result.compilerMessage.trim() !== "") {
            innerHTML += `
<div class="row item">
<div class="col-12">
<div class="box">
